...
Middleware::Middleware(ros::NodeHandle &nh) : nh_(nh), action_(nh_,
  ...
  chassis_interface_ = new ChassisInterface(nh);
  chassis_interface_thread_ = new std::thread(&ChassisInterface::chassisInterfaceThread, chassis_interface_);
  chassis_interface_thread_->detach();
